...
def check_fragment(token, openId):
    ...
    headers = {
        ...
        'content-type': "application/json",
        'timestamp': f"{int(time.time() * 1000)}",
        #   'signature': "KvsCTGeRbJw9gdkJrvR1PaXYCcxvcEsRTs8GJMH4dTqoj/4MH4/UNh6niItZihZB4iiPSIf0K5BWBr2tNoy79ZBMaP+K5JUtg2qWp5ti8p+LNjXo57HH6xHCo+VaqleuHkxuVzJLdAgHUajjj1a8QjwICHKShBcuvBMDTHjr8tWj2YH7sZMC8PGVltllIBvpNySRtTHhy52QPY+Frko5jBYWkUk/8Wnsl+7W9jZdoCk=",
        'xweb_xhr': "1",
        'access_token': token,
        # 'uniquecode': "1734248000635&633794",
        'token': token,
        'app-version': "1.1.1",
        'sec-fetch-site': "cross-site",
        'sec-fetch-mode': "cors",
...
def get_newtoken(phoneNum, openId, unionId, authorizationCode, context_id):
    ...
    headers = {
        ...
        'xweb_xhr': "1",
        # 'access_token': "eyJ1c2VySWQiOjk1MjcsInRpbWVzdGFtcCI6MTczNTgwNDE4MDQ2N30=.0c5f4769de97bb16a3647d3e3315a163",
        # 'uniquecode': "1735804403205&514475",
        # 'token': "eyJ1c2VySWQiOjk1MjcsInRpbWVzdGFtcCI6MTczNTgwNDE4MDQ2N30=.0c5f4769de97bb16a3647d3e3315a163",
        'app-version': "1.1.1",
        'sec-fetch-site': "cross-site",
        'sec-fetch-mode': "cors",
        'sec-fetch-dest': "empty",
